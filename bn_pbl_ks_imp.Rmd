...
bn_ks <- read.csv2("C:/Users/Cezary/Downloads/bn_ks_2012.csv", encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE) %>%
...
write.csv2(na_pozniej, "C:/Users/Cezary/Desktop/bn_2012_ks_na_pozniej.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.csv2(automatyczny_IOK, "C:/Users/Cezary/Desktop/imp_2012_automatyczne_podmiotowe.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
for (i in x) {
  ...
  final <- out %>%
    ...
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Cezary/Desktop/2012_podmiotowa_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Cezary/Desktop/2012_przedmiotowa_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Cezary/Desktop/2012_antologie_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Cezary/Desktop/2012_wspolwydanie_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
nadpisanie_zapisow_IOK <- read.csv2("C:/Users/Cezary/Desktop/imp_2012_automatyczne_podmiotowe.csv", encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE)
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(nadpisanie_zapisow_IOK, "C:/Users/Cezary/Desktop/2012_nadpisanie_zapisow_IOK.xlsx",sheetName = "ZA_STATUS_IMP")
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(rocznik_pbl_po_imporcie, "C:/Users/Cezary/Desktop/ks_BN_2012_listy_pracowników.xlsx",sheetName = "lista_ksiazek")
