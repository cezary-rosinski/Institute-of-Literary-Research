...
bn_ks <- read.csv2("C:/Users/Nikodem/Downloads/bn_ks_2010.csv", encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE) %>%
...
do_importu_NIE <- rbind(listy_2004,listy_2005,listy_2006,listy_2007,listy_2008, listy_2009) %>%
...
#aktualizacja - dodaj do skryptu listę z ostatnim brakującym zaimportowanym rocznikiem
do_importu_NIE2 <- rbind(listy_2004,listy_2005,listy_2006,listy_2007,listy_2008, listy_2009) %>%
  full_join(.,zapisy,by = "ZA_ZAPIS_ID") %>%
...
#aktualizacja - dodaj do skryptu listę z ostatnim brakującym zaimportowanym rocznikiem
gatunki_poprzednie_imp <- rbind(listy_2004,listy_2005,listy_2006,listy_2007,listy_2008, listy_2009) %>% 
...
write.csv2(na_pozniej, "C:/Users/Nikodem/Desktop/bn_2010_ks_na_pozniej.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
#aktualizacja - dodaj do skryptu listę z ostatnim brakującym zaimportowanym rocznikiem
poprzednie_importy <- rbind(listy_2004,listy_2005,listy_2006,listy_2007,listy_2008, listy_2009) %>%
  full_join(.,zapisy,by = "ZA_ZAPIS_ID") %>%
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.csv2(automatyczny_IOK, "C:/Users/Nikodem/Desktop/imp_2010_automatyczne_podmiotowe.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
for (i in x) {
  ...
  final <- out %>%
    ...
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Nikodem/Desktop/2010_podmiotowa_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Nikodem/Desktop/2010_przedmiotowa_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Nikodem/Desktop/2010_antologie_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
for (i in x) {
  ...
  final <- out %>%
    filter(podzial %in% ile[[i]]) %>%
    select(-podzial)
  write.xlsx(final, paste("C:/Users/Nikodem/Desktop/2010_wspolwydanie_do_importu",i,".xlsx",sep = ""),sheetName = "gotowe")
}
```
...
nadpisanie_zapisow_IOK <- read.csv2("C:/Users/Nikodem/Desktop/imp_2010_automatyczne_podmiotowe.csv", encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE)
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(nadpisanie_zapisow_IOK, "C:/Users/Nikodem/Desktop/2010_nadpisanie_zapisow_IOK.xlsx",sheetName = "ZA_STATUS_IMP")
...
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(rocznik_pbl_po_imporcie, "C:/Users/Nikodem/Desktop/ks_BN_2010_listy_pracowników.xlsx",sheetName = "lista_ksiazek")
