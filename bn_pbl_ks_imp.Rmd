...
count <- as.data.frame(table(chunk6$dziedzina_PBL,chunk6$rodzaj_ksiazki,chunk6$czy_automatycznie))
...
```{r błędy do ręcznego poprawienia}
#kilka rekordów, zazwyczaj dwa dostaje redaktora NA
#najlepiej znaleźć te rekordy bezpośrednio przy użyciu formularza i przypisać redaktorów ręcznie
#wyszukaj w uwagach %akceptuje:NA% i wpisz nick redaktora
