...
#aktualizacja - wprowadź właściwy rok do ścieżki
...
# sprawdz czy id tworcy z ktorejs tabeli na dysku istnieje w bazie oracle, jesli nie, wklej id tworcy z oracla do tabeli
bezpiecznik <- bn_ks %>% 
...
automatyczny_IOK <- polaczone %>%
  ...
  mutate(powinno_byc = "IOK")
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.csv2(automatyczny_IOK, "C:/Users/Cezary/Desktop/imp_2010_automatyczne_przedmiotowe.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
automatyczny_IOK <- polaczone %>%
  ...
  mutate(powinno_byc = "IOK")
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.csv2(automatyczny_IOK, "C:/Users/Cezary/Desktop/imp_2010_automatyczne_antologie.csv", row.names = F, na = '', fileEncoding = 'UTF-8')
...
for (i in x) {
  ...
  nadpisanie_zapisow_IOK <- nadpisanie_zapisow_IOK %>% 
    bind_rows(.,read.csv2(paste("C:/Users/Cezary/Desktop/imp_2010_automatyczne_",rodzaje[i],".csv",sep = ""), encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE))
}
...
nadpisanie_tworcow_IOK <- dbGetQuery(PBL,
                                     "select tw.tw_tworca_id
                                      ...
                                      where tw.tw_uwagi like '%2010~%'") %>% 
  mutate(ID2 = NA,
         jest = "IMP",
         powinno_byc = "IOK")
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(nadpisanie_tworcow_IOK, "C:/Users/Cezary/Desktop/2010_nadpisanie_tworcow_IOK.xlsx",sheetName = "TW_STATUS")
...
rocznik_pbl_po_imporcie <- dbGetQuery(PBL,
  ...
  select(noquote(kolejnosc))
#aktualizacja - wpisz właściwy rok w ścieżkę pliku
write.xlsx(rocznik_pbl_po_imporcie, "C:/Users/Cezary/Desktop/ks_BN_2010_listy_pracowników.xlsx",sheetName = "listy_pracownikow")
...
#masowy IOK dla nowych twórców w bazie
