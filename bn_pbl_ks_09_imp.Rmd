...
########## TUTAJ uzupełnić przydział dla współwydań (prawdopodobnie wystarczy zastosować schemat dla literatury podmiotowej - od mapowania twórców)
# być może nie powinniśmy przy tworzeniu twórców bazować na polu X100 - sprawdzić, czy wcześniej wykorzystano pole X245
