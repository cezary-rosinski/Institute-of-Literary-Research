...
#TUTAJ# - nie może być gatunków w tytułach - usunąć albo wybrać wcześniejsze przetworzenie, które tego jeszcze nie ma!
za_opis_ks <- za_opis_ks %>% 
...
za_opis_ks <- za_opis_ks %>% 
  mutate(za_uwagi2 = ifelse(grepl("b$", za_uwagi2), as.character(za_uwagi2),paste(za_uwagi2,"b",sep = "")))
