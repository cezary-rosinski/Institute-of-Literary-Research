...
kartoteka_osob <- sheets_read(ss = "1Y8Y_pfkuKiv5npL6QJAXWbDO6twIJqsK3ArvaokjFkU", sheet = "samizdat") %>% 
  ...
  filter(!is.na(name_form)) %>% 
  mutate(name_form = str_remove(name_form,", NA")) %>% 
  cSplit("name_form_id",sep = "-",direction = "wide")

kartoteka_osob <- kartoteka_osob %>% 
  

kartoteka_osob <- kartoteka_osob %>% 
  mutate(Project_ID = ifelse(name_form_id_1=="bn_books",1,
                             ifelse(name_form_id_1=="cz_books",2,
                                    ifelse(name_form_id_1=="cz_articles",3,
                                           ifelse(name_form_id_1=="pbl_books",4,5)))),
         LOD_ID = NA,
         Index_Name = ifelse(name_form_id_1=="bn_books"&(name_form_id_4=="X100"|name_form_id_4=="X700"|name_form_id_4=="X701")&name_form_id_5=="%1",as.character(name_form),
                             ifelse((name_form_id_1=="cz_books"|name_form_id_1=="cz_articles")&(name_form_id_4=="X100"|name_form_id_4=="X600"|name_form_id_4=="X700")&name_form_id_5=="$$a",as.character(name_form),
                                    ifelse((name_form_id_1=="pbl_books"|name_form_id_1=="pbl_articles")&name_form_id_2=="tworcy",as.character(name_form),NA))))
