...
abc <- oaih_harvest(baseurl = baseurl,from = "2020-02-28")

oaih_size(baseurl)
oaih_list_identifiers(baseurl = baseurl, prefix = "marc21", from = "2020-02-28",
until = NULL, set = "NKC", transform = TRUE)



doc <- OAIHarvester::oaih_get_record(baseurl = baseurl,identifier = "oai:aleph-nkp.cz:NKC01-003165865",prefix = "marc21",transform = FALSE)
