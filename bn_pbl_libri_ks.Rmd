...
for (import_year in roczniki) {
import_year <- 2013
#wgranie zbiorów książek
bn_ks <- read.csv(paste("C:/Users/",employee_name,"/Downloads/bn_ks_",import_year,".csv",sep = ""), encoding = "UTF-8", header = TRUE, stringsAsFactors = FALSE) %>%
